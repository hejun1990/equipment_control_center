...
import static com.geekbang.equipment.management.core.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/equipment_control_center?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false&nullCatalogMeansCurrent=true";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "admin";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.cj.jdbc.Driver";
    //项目在硬盘上的基础路径
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/equipment_management";
    //模板位置
    ...
    // @author
    private static final String AUTHOR = "hejun";
    // @date
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());

    public static void main(String[] args) {
        genCode("device_info");
//        genModelAndMapper("device_info", null);
//        genService("device_info", null);
//        genController("device_info", null);
    }
